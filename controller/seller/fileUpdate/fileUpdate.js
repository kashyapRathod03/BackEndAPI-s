...
exports.updateData = async(req, res) => {
    ...
    if (!jwtToken) {
        ...
        //  console.log(e);
        const updateQuery = 'UPDATE seller_info SET catagory=?, description=?, quantity=?, city=?, imageUrl=? WHERE waste_name=? AND email=?';
        connection.query(updateQuery, [ catagory, description, quantity, city, imageUrl, waste_name, e], (err, result) => {
            if (err) {
