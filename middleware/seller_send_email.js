...
const fsetpassword = (req,res,next)=>{
    const {password,email} = req.body;
    const query = "UPDATE sellers SET password = ? WHERE email = ?";
    console.log(email);
...
module.exports = { fsendemail, fcheckotp, fsetpassword };